                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __('words.consultation_request_from') }} :
                                                                        {{ $consultation_request->name }}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table
                                                            ...
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                style="padding:20px;Margin:0"><h4
                                                                    ...
                                                                    {{__('words.contact_details')}} : {{$consultation_request->fname}} {{$consultation_request->lname}}</h4>
                                                            </td>
                                                        </tr> --}}
                                                            <tr style="border-collapse:collapse">
                                                                <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                <strong>{{ __('words.phone') }}:
                                                                                    ...
                                                                                    dir="ltr">{{ $consultation_request->phone }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                <strong>{{ __('words.email') }}
                                                                                    :
                                                                                </strong>{{ $consultation_request->email }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    bgcolor="#0071bc"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#0071bc;width:600px;color: #ffffff">
                                    <tr style="border-collapse:collapse">
                                        <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%"
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                                        style="padding:0;Margin:0;width:560px;text-align: center;font-size: 10px;color: white">
